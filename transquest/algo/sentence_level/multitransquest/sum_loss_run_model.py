...
class MultiTransQuestModel:
    def __init__(
        ...
        self.config.update({'num_tasks': self.args.num_tasks, 'list_labels': self.args.num_labels, 'grad_weights': self.args.grad_weights, \
                            'num_shared_decoder_layers':self.args.num_shared_decoder_layers, 'num_separate_decoder_layers':self.args.num_separate_decoder_layers, 'id2label':None, 'label2id':None})
